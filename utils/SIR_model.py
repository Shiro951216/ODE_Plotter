...
def model_SIR(initial_conditions, beta, gamma, t, t_change=None, new_beta=None, new_gamma=None):
    """
    ...
    def SIR_odeint(y, t, beta, gamma, change_time=None, new_beta=None, new_gamma=None):
        S, I, R = y
        
        # Apply condition for changing beta and gamma
        if (change_time != None) and (t > change_time):
    ...
    solution = odeint(func = SIR_odeint, y0 = initial_conditions, t = time_points, 
